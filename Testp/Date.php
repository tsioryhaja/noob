...
font-size: 16px;"> &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <div class="sidebar-collapse">
                ...
                <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="IPvisiteur.php">Par IP Visisteur</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <form role="form" action="Datecible.php" method="POST">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group has-warning">
                                            ...
                                            <input type="date" class="form-control" id="inputWarning" name="datestart" >
                                        </div>
                                        <div class="form-group has-warning">
                                            <label class="control-label" for="inputWarning">TIME Start</label>
                                            <input type="time" class="form-control" id="inputWarning" name="timestart" >
                                        </div>
                                        <div class="form-group has-warning">
                                            <label class="control-label" for="inputWarning">DATE End</label>
                                            <input type="date" class="form-control" id="inputWarning" name="dateend" >
                                        </div>
                                        <div class="form-group has-warning">
                                            <label class="control-label" for="inputWarning">TIME End</label>
                                            <input type="time" class="form-control" id="inputWarning" name="timeend" >
                                        </div>
