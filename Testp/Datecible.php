                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                              <?php 
                                    ...
                                    $datee = $_POST['dateend'];
                                    $timee = $_POST['timeend'];
                                if(isset($ipdst) && isset($dates) && isset($times) && isset($datee) && isset($timee))
                                {
                                ...
                                while ($donneesVisitor2 = $responseVisitor2->fetch())
                                {
                                    ...
                                    $row2 = $bdd->query('select distinct ipsrc from '.$recup2.' where date between \''.$dateA.'\'  and \''.$dateB.'\' ' );
                                    while ($datab= $row2->fetch())
                                    {
                                    $recup3 = $datab['ipsrc'];
                                    $row3 = $bdd->query('select distinct infosys,mac_src,ip_src from local_log where ip_src = \''.$recup3.'\'');
