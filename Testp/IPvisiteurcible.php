        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                              <?php 
                                ...
                                if (preg_match('#^([0-9]{1,3}\.){3}[0-9]{1,3}$#', $ipdst)) {
                                ...
                                //on recupere les ip des nomdomaine
                                $recupecho= gethostbyname($ipdst);
                                ...
                                while ($donneesVisitor2 = $responseVisitor2->fetch())
                            {
                                ...
                                $row2 = $bdd->query('select distinct ipsrc,time,date,dport from '.$recup2.' where ipdst =\''.$recupecho.'\'');
                ...
                while ($datab = $row2->fetch())
                {
                    ...
                    $recup3 = $datab['ipsrc'];
                        //echo "IP:".$recup3.":".$datab['dport']." date ".$datab['date']." time ".$datab['time']."venant de ".$recup2."<br/>";
                    
                    
                    $row3 = $bdd->query('select  * from local_log where ip_src = \''.$recup3.'\' ');//diso
                    ...
                    {  
                        ...
                        ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $datab['dport'];?></td>
                                        <td><?php echo $datab2['mac_src'];?></td>
                                        <td><?php echo $datab['date'];?></td>
                                        <td><?php echo $datab['time'];?></td>
                                        <td><?php echo $recup2;?></td>
                                    </tr>
                ...
                ?>
                         <a><input type="button" name="map" value="MAP" onclick="javascript:location.href='openmap.php'" /><a>
                    <?php
                ?>
                </table>
                <?php
