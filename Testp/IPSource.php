...
font-size: 16px;"> &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <form role="form" action="IPSourcecible.php" method="POST">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group has-warning">
                                            <label class="control-label" for="inputWarning">IP Source</label>
                                            <input type="text" class="form-control" id="inputWarning" name="ipsrc" >
                                        </div>
